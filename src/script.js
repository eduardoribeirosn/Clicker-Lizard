...
export let qtdAddZengia = 0.2;

// Imports -> Todos
import { addZengiaManual } from "./JS/Energias/Zengia/zengiaBase.js"
...
function botoesDaTelaGame() {
    ...
    document.getElementById('idMainButton').addEventListener('click', function(evento) {
        ...
        textoFlutuante.innerText = `+${getQtdAddZengia()}`; // Ou o valor do seu poder de clique
...
export function setZengiaAtual(newValueZengia) {
    zengiaAtual = newValueZengia
}

// Quantidade Ganha por Click -> Zengia
export function getQtdAddZengia() {
    return qtdAddZengia
}
export function setQtdAddZengia(newQtdAddZengia) {
    qtdAddZengia = newQtdAddZengia
}